...
for (def index : 0..data.getRowNumbers() - 1) {
	...
	transactionId = CustomKeywords.'com.SwisslogUtilities.getTransactionId'()
	
	CustomKeywords.'com.SwisslogUtilities.registerCarrier' data.internallyGetValue("Carrier", index), data.internallyGetValue("Type", index), data.internallyGetValue("PrepStation", index), data.internallyGetValue("Identifier", index), 'true'
