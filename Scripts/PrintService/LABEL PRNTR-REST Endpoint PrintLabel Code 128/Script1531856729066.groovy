 ...
 * TEST NAME: LABEL PRNTR-REST Endpoint PrintLabel Code 128
 * DESCRIPTION: This test will execute the above named endpoint and will use parameters to print to the LABEL PRINTER, a virtual printer
 * named 'Label Printer'.
 * Parameter Notes:
 ...
 *                   the Label Printer will print out at the label printer with Bar code Type Code128.
 */
...
out.println("**************************************************************")
out.println("**           POST Label Printer - REST Endpoint             **")
...
body("{\"requestID\": \"9ae9e09b-9a1d-4ba0-b941-3e86f5421219\",	" + 
	"\"requestLayout\": \"Delivery Manager Order Label Type Code 128\"," + 
	"\"requestPrinter\": \"Label Printer\"," + 
	"\"swisslogUniqueId\": \"SWLG-1000-DO-502\"," + 
	"\"itemName\": \"Label Printer Code 128\"," + 
	"\"destinationLocationName\": \"test Label data DESTINATION\"}")
...
if (response.statusCode == 200 || response.statusCode == 201)
{
	...
	out.println("** Check Label Printer for a label with                     **")
	out.println("**   item: Label Printer Code 128                           **")
}
else
{
