 ...
 * TEST NAME: LABEL PRNTR-REST Endpoint PrintLabel Code 39
 ...
 * EXPECTED RESULTS: Endpoint Returns an http code 200 
 *                   and Label Printer will print out at the label printer with Bar code Type Code39.
 */
...
if (response.statusCode == 200 || response.statusCode == 201)
{
	...
	out.println("**   item: Label Printer Code 39                            **")
}
else
{
